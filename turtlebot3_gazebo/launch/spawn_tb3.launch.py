...
def generate_launch_description():
    ...
    generated_sdf_path = '/tmp/model_generated.sdf'
    ...
    cmd=['xacro', urdf_path,
         'namespace:=', namespace, '-o', '/tmp/model_generated.sdf'],
    output='screen'
    )
    ...
    declare_namespace_cmd = DeclareLaunchArgument(
        ...
        description='Namespace for the robot instance in Gazebo')
